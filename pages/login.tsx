  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center h-screen gap-3 text-white ">
        ...
        />
        <div className="font-mono ">Welcome to KwanBarber</div>

        <button
          onClick={() => handleSignIn("google")}
          className="flex items-center justify-center gap-2 p-2 font-mono text-white border border-white rounded-md bg-slate-800"
        >
